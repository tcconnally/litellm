...
async def get_current_spend(
    ...
    # spend this caller already knows about. Window counters have no such
    # signal (fallback is 0), so they always re-check, bounded by the cache.
    is_window = window_start is not None
    if fallback_spend > current or is_window:
